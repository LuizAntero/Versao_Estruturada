...
/**
 * Exemplo de programação procedural (estruturada) 
 */
public class Programa1 {
    ...
    private static int[] qtdVendidoProdutos;
    ...
    public static void criarDadosTeste(){
        ...
        nomeClientes = new String[] {"Maria", "Felipe", "José"};
        enderecoClientes = new String[]{"Rua Y, 231", "Rua F, 150", "Rua W, 300"};
        codigoProdutosVendidos = new int[]{1, 2, 3};
        qtdVendidoProdutos = new int[]{1, 6, 1};
        codigoVendedores = new int[] {1, 2};
        nomeVendedores = new String[]{"Otávio", "Aline"};
        ...
        for (int contProdutoVendido = 0; contProdutoVendido < codigoProdutosVendidos.length; contProdutoVendido++){
            ...
            for (int contProduto = 0; contProduto < codigoProdutos.length; contProduto++){
                ...
                if (codigoProdutoVendido == codigoProduto){
                    ...
                    int qtdItem =  qtdVendidoProdutos[contProduto];
                    float totalItem = valorProduto*qtdItem;
                    estoqueProdutos[contProduto] = estoqueProduto - qtdItem;
                    ...
                    System.out.println("   Quantidade Item: " + qtdItem);
                    System.out.println("             Valor: " + valorProduto);
                    System.out.println("        Total Item: " + totalItem);                    
                }
            }       
        }
        //Busca nome do vendedor e calcula comissão    
